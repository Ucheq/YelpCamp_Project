...
const campData = [
  ...
  const btn = `<div class="flex justify-end pt-4 items-center"><button id="addReviewBtn" class="bg-black text-lg text-white flex gap-5 p-3"><img src="./Assets/ChatBubble.svg" alt="chat bubble"/><p>Leave a review</p></button></div>`;
